...
export default [
        ...
        { route: ['archivedgifts', 'archivedgifts/index'], name: 'archivedgiftsIndex', moduleId: PLATFORM.moduleName('views/archivedgifts/index'), nav: true, title: 'ArchivedGifts' },
        ...
        { route: ['campaigndonatees', 'campaigndonatees/index'], name: 'campaignDonateesIndex', moduleId: PLATFORM.moduleName('views/campaigndonatees/index'), nav: true, title: 'CampaignDonatees' },
        ...
        { route: ['donatees', 'donatees/index'], name: 'donateesIndex', moduleId: PLATFORM.moduleName('views/donatees/index'), nav: true, title: 'Donatees' },
        ...
        { route: ['friendships', 'friendships/index'], name: 'friendshipsIndex', moduleId: PLATFORM.moduleName('views/friendships/index'), nav: true, title: 'Friendships' },
        ...
        { route: ['gifts', 'gifts/index'], name: 'giftsIndex', moduleId: PLATFORM.moduleName('views/gifts/index'), nav: true, title: 'Gifts' },
        ...
        { route: ['invitedusers', 'invitedusers/index'], name: 'invitedusersIndex', moduleId: PLATFORM.moduleName('views/invitedusers/index'), nav: true, title: 'InvitedUsers' },
        ...
        { route: ['notifications', 'notifications/index'], name: 'notificationsIndex', moduleId: PLATFORM.moduleName('views/notifications/index'), nav: true, title: 'Notifications' },
        ...
        { route: ['notificationtypes', 'notificationtypes/index'], name: 'notificationtypesIndex', moduleId: PLATFORM.moduleName('views/notificationtypes/index'), nav: true, title: 'NotificationTypes' },
        ...
        { route: ['permissions', 'permissions/index'], name: 'permissionsIndex', moduleId: PLATFORM.moduleName('views/permissions/index'), nav: true, title: 'Permissions' },
        ...
        { route: ['privatemessages', 'privatemessages/index'], name: 'privatemessagesIndex', moduleId: PLATFORM.moduleName('views/privatemessages/index'), nav: true, title: 'PrivateMessages' },
        ...
        { route: ['profiles', 'profiles/index'], name: 'profilesIndex', moduleId: PLATFORM.moduleName('views/profiles/index'), nav: true, title: 'Profiles' },
        ...
        { route: ['reservedgifts', 'reservedgifts/index'], name: 'reservedgiftsIndex', moduleId: PLATFORM.moduleName('views/reservedgifts/index'), nav: true, title: 'ReservedGifts' },
        ...
        { route: ['usercampaigns', 'usercampaigns/index'], name: 'usercampaignsIndex', moduleId: PLATFORM.moduleName('views/usercampaigns/index'), nav: true, title: 'UserCampaigns' },
        ...
        { route: ['usernotifications', 'usernotifications/index'], name: 'usernotificationsIndex', moduleId: PLATFORM.moduleName('views/usernotifications/index'), nav: true, title: 'UserNotifications' },
        ...
        { route: ['userpermissions', 'userpermissions/index'], name: 'userpermissionsIndex', moduleId: PLATFORM.moduleName('views/userpermissions/index'), nav: true, title: 'UserPermissions' },
        ...
        { route: ['userprofiles', 'userprofiles/index'], name: 'userprofilesIndex', moduleId: PLATFORM.moduleName('views/userprofiles/index'), nav: true, title: 'UserProfiles' },
