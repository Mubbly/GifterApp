...
namespace WebApp.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NotificationValue,Comment,NotificationTypeId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("NotificationValue,Comment,NotificationTypeId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Notification notification)
        {
