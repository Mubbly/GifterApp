...
namespace WebApp.Controllers
{
    public class ReservedGiftsController : Controller
    {
        ...
        {
            var appDbContext = _context.ReservedGifts.Include(r => r.ActionType).Include(r => r.AppUser).Include(r => r.Gift).Include(r => r.Status).Include(r => r.UserGiver).Include(r => r.UserReceiver);
