...
namespace WebApp.Controllers
{
    public class DonateesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,Gender,Age,Bio,GiftName,GiftDescription,GiftImage,GiftUrl,GiftReservedFrom,ActiveFrom,ActiveTo,IsActive,ActionTypeId,StatusId,Id,CreatedBy,CreatedAt,EditedBy,EditedAt")] Donatee donatee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FirstName,LastName,Gender,Age,Bio,GiftName,GiftDescription,GiftImage,GiftUrl,GiftReservedFrom,ActiveFrom,ActiveTo,IsActive,ActionTypeId,StatusId,Id,CreatedBy,CreatedAt,EditedBy,EditedAt")] Donatee donatee)
        {
            if (id != donatee.Id)
            {
                return NotFound();
