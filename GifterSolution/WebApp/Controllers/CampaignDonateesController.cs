...
namespace WebApp.Controllers
{
    public class CampaignDonateesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IsActive,Comment,CampaignId,DonateeId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] CampaignDonatee campaignDonatee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("IsActive,Comment,CampaignId,DonateeId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] CampaignDonatee campaignDonatee)
        {
