...
namespace WebApp.Controllers
{
    public class FriendshipsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IsConfirmed,Comment,AppUser1Id,AppUser2Id,AppUserId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Friendship friendship)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("IsConfirmed,Comment,AppUser1Id,AppUser2Id,AppUserId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Friendship friendship)
        {
            if (id != friendship.Id)
            {
                return NotFound();
