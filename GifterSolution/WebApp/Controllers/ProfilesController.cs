...
namespace WebApp.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfilePicture,Gender,Bio,Age,IsPrivate,WishlistId,AppUserId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProfilePicture,Gender,Bio,Age,IsPrivate,WishlistId,AppUserId,CreatedBy,CreatedAt,EditedBy,EditedAt,Id")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
