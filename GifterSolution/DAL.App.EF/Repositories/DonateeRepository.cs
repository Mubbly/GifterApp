...
namespace DAL.App.EF.Repositories
{
    public class DonateeRepository :
        EFBaseRepository<AppDbContext, DomainAppIdentity.AppUser, DomainApp.Donatee, DALAppDTO.Donatee>,
        IDonateeRepository
    {
        public DonateeRepository(AppDbContext dbContext) :
            base(dbContext, new BaseMapper<DomainApp.Donatee, DALAppDTO.Donatee>())
        {
        }
