...
namespace DAL.App.EF.Repositories
{
    public class UserNotificationRepository :
        EFBaseRepository<AppDbContext, DomainAppIdentity.AppUser, DomainApp.UserNotification, DALAppDTO.UserNotification
        >,
        IUserNotificationRepository
    {
        public UserNotificationRepository(AppDbContext dbContext) :
            base(dbContext, new BaseMapper<DomainApp.UserNotification, DALAppDTO.UserNotification>())
        {
        }
