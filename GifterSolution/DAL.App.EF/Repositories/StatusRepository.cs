...
namespace DAL.App.EF.Repositories
{
    public class StatusRepository :
        EFBaseRepository<AppDbContext, DomainAppIdentity.AppUser, DomainApp.Status, DALAppDTO.Status>,
        IStatusRepository
    {
        public StatusRepository(AppDbContext dbContext) :
            base(dbContext, new BaseMapper<DomainApp.Status, DALAppDTO.Status>())
        {
        }
